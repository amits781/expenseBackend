package com.aidyn.expense.splitwise;
...
public class Splitwise {
    ...
    public Splitwise(String consumerKey, String consumerSecret){
        ...
        this.setUtil(new OAuthUtil().setApiKey(this.consumerKey)
    ...
    public String getAuthorizationUrl() throws InterruptedException, ExecutionException, IOException {
        return this.getUtil().getAuthorizationUrl();
    }
    ...
    public Token getAccessToken(String verifier) throws InterruptedException, ExecutionException, IOException {
        this.getUtil().setAccessToken(verifier);
        return this.getUtil().getAccessToken();
    }
    ...
    public String getCurrentUser() throws Exception {
        Response response = this.getUtil().makeRequest(String.format(URL.GET_CURRENT_USER, Strings.SPLITWISE_API_VERSION)
                , Verb.GET);
    ...
    public String getUser(String userId) throws Exception {
        ...
        Response response = this.getUtil().makeRequest(url, Verb.GET);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String updateUser(String id, Map<String, String> details) throws Exception {
        ...
        Response response = this.getUtil().makeRequest(url, Verb.POST, details);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String getGroups() throws Exception {
        Response response = this.getUtil().makeRequest(URL.GET_GROUPS, Verb.GET);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String createGroup(Map<String, String> details) throws Exception {
        Response response = this.getUtil().makeRequest(URL.CREATE_GROUP_URL, Verb.POST, details);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String deleteGroup(String id) throws Exception {
        ...
        Response response = this.getUtil().makeRequest(url, Verb.POST);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String addUserToGroup(Map<String, String> userDetails) throws Exception {
        Response response = this.getUtil().makeRequest(URL.ADD_USER_TO_GROUP, Verb.POST, userDetails);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String removeUserFromGroup(final String groupId, final String userId) throws Exception {
        ...
        Response response = this.getUtil().makeRequest(URL.REMOVE_USER_FROM_GROUP, Verb.POST, details);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String getFriends() throws Exception {
        Response response = this.getUtil().makeRequest(URL.GET_FRIENDS, Verb.GET);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String createFriend(final String firstName, final String lastName, final String email) throws Exception {
        ...
        Response response = this.getUtil().makeRequest(URL.CREATE_FRIEND, Verb.POST, friendDetails);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String getExpenses() throws Exception {
        Response response = this.getUtil().makeRequest(URL.GET_EXPENSES, Verb.GET);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String getNotifications() throws Exception {
        Response response = this.getUtil().makeRequest(URL.GET_NOTIFICATIONS, Verb.GET);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String getCurrencies() throws Exception {
        Response response = this.getUtil().makeRequest(URL.GET_CURRENCIES, Verb.GET);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public String getCategories() throws Exception {
        Response response = this.getUtil().makeRequest(URL.GET_CATEGORIES, Verb.GET);
        if (response.getCode() == 200)
            return response.getBody();
        return null;
    }
    ...
    public static void main(String... args) throws Exception {
        ...
        splitwise.getUtil().setAccessToken("<verifier_from_authorizationURL>");
	...
	public OAuthUtil getUtil() {
		return util;
	}

	public void setUtil(OAuthUtil util) {
		this.util = util;
	}
}
